...
The following parameters in params.txt control how getorganelle and blast run, these generally don't need changing, unless you analyse different organelle genome or need to increase the getorganelle read rounds. 
```
# ============================
# GETORGANELLE
# ============================
